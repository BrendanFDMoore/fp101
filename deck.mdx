...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [6, 10], notes: 'We can build an object to bundle ideas' },
    { range: [12, 13], notes: 'Or create a helper to compose functions together' },
    { range: [15, 23], notes: 'and then build more interesting effects.' }
  ]}
/>
---
